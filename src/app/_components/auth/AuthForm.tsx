...
export default function AuthForm() {
  ...
  return (
    <div className="w-full flex justify-center items-center flex-col gap-2">
      <p className="text-[14px] font-medium">Escolha como entrar:</p>
      ...
      <div className="bg-[#D9D9D9] h-[1px] w-full" />
      <Button
      ...
      <div className="bg-[#D9D9D9] h-[1px] w-full" />
      <Link className="text-[13px]" href="/signup">
        Não tem uma conta?
        <span className="ml-1 text-[#5C45FD]">Registrar-se</span>
      </Link>
    </div>
  );
}
